...
parasite/target/release/ecoop-artifact --datastore datasets/dataset export query-results/paper/experienced_author.list          query-results/paper/experienced_author.csv
...
```{bash}
parasite/target/release/ecoop-artifact --datastore datasets/dataset compact query-results/paper/stars.csv                       query-results/paper/paper/stars_p.csv                 query-results/paper/stars_pl.csv      
