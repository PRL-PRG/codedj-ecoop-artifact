...
│   └── toy-dataset                               # A toy dataset containig data for 10 repositories used in tutorials.
...
├── models                                        # Coefficients and samples generated for data analysis from query-results.
